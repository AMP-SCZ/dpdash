...
export const chartDataAbstractor = (individualCountsList, fieldValues) =>
  Object.values(
    individualCountsList.reduce(function (currentSiteData, nextSiteData) {
      currentSiteData[nextSiteData.fieldLabel] =
        currentSiteData[nextSiteData.fieldLabel] || []
    ...
    Object.values(
      groupedCounts.reduce((currentSite, nextSite) => {
          ...
          ? {
              ...
              target:
                ...
                fieldValues
                  .find(
                    ({ fieldLabelValueMap }) =>
                      fieldLabelValueMap.label === nextSite.fieldLabel
                  )
                  .fieldLabelValueMap.targetValues.find(
                    ({ site }) => site === nextSite.siteName
                  ).value,
            }
          : nextSite
